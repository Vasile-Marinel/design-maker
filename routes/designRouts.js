...
const auth = require('../middlewares/middleware') // Importam middleware-ul de autentificare

router.post('/create-user-design', auth, designController.create_user_design) // Ruta pentru crearea unui design de utilizator
router.get('/user-design/:designId', auth, designController.get_user_design) // Ruta pentru obtinerea unui design de utilizator
...
router.post('/upload-user-image', auth, designController.upload_user_image) // Ruta pentru incarcarea unei imagini de utilizator
...
router.put('/delete-user-design/:designId', auth, designController.delete_user_design) // Ruta pentru incarcarea unei imagini de utilizator
